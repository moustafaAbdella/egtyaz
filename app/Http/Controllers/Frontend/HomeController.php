...
class HomeController extends Controller
{
    ...
    public function packages()
    {
        ...
        $packages = Packages::where('status', 1)->whereIn('id', [5,6,7])->get();
        $secondaryPackages = Packages::where('status', 1)->whereNotIn('id', [5,6,7])->get();
        $PackageRoles = Packages::PackgeRoles() ;
        return view('frontend.packages', compact('packages', 'PackageRoles', 'secondaryPackages'));
     }
