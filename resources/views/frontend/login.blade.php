	    	...
	    	<div class="container">
	    		<div class="row">
	    			<div class="col-md-6 hidden-sm hidden-xs">
			    		<div class="mask">
			    			<img src="{{ asset('/frontend/images') }}/school-boy-yellow-shirt-taking-virtual-classes-raising-hand-min.jpg" />
	    			...
	    			<div class="col-md-6">
						...
						@csrf
			    			...
			    			<button onclick="emailSubmit()" class="btnSingUp">تسجيل الدخول</button>
			    			<center>
...
<script>
    function emailSubmit() {
        ...
        alert(email);
        document.getElementsByTagName('meta')["user_email"].content = email;
    }
</script>
