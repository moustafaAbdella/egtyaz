		...
		<div class="Breadcrumb">
 	    ...
 	    <div class="singUp">
	    	<div class="container">
				...
				@endif
	    		<form method="POST" action="{{ route('register') }}{{ Request::get("referer") ? '?referer='.Request::get("referer") : null }}{{ Request::get('p') ? '?p=' . Request::get('p') : null }}" class="formSing validate-form">
				@csrf
	    			<div class="row">
	    				<div class="col-md-6">
