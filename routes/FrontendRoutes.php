...
Route::post('password/reset', [ResetPasswordController::class, 'reset'])
    ...
    Route::get('/package', 'Frontend\HomeController@packages')->name('home.packages');
    
    Route::resource('/article', 'Frontend\ArticleController');
    Route::get('/downloads', 'Frontend\DownloadController@index');
